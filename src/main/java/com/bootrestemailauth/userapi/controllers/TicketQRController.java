...
public class TicketQRController {
    ...
    public ResponseEntity<?> removeQRticket(@RequestHeader("Authorization") String authorization,@RequestParam("monument_name") String monument_name,@RequestParam("date_of_visit")Date date_of_visit){
